...
(cl:defmethod cl:initialize-instance :after ((m <Floats>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Floats)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mouse_controller-msg:<Floats> is deprecated: use mouse_controller-msg:Floats instead.")))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <Floats>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mouse_controller-msg:data-val is deprecated.  Use mouse_controller-msg:data instead.")
  (data m))
