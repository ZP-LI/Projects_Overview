...
%     filename1 = ['Neuer Ordner\test_freilegen_Mit_P' num2str(i) '.lvm'];
%     filename2 = ['Neuer Ordner\test_freilegen_Ohne_P' num2str(i) '.lvm'];
%     filename3 = ['Neuer Ordner\test_gespannt_Mit_P' num2str(i) '.lvm'];
%     filename4 = ['Neuer Ordner\test_gespannt_Ohne_P' num2str(i) '.lvm'];
filename_test = ['Neuer Ordner\test_x_0001.lvm'];
