...
file = load("Ergebnis1117_14/Parameter_results_X7");
% K_0 = file.results_X(1:4,1)';
K_0 = file.results_X(5:8,1)';

% K_0 = [1.0030e+04, 418.5032, 2.6273e+07, 2.2550e+07];
% K_0 = [1.8986e+03, 197.0634, 1.7008e+07, 4.9672e+05];
% K_0 = [490.4250, 1.6118, 6.3635e+04, 6.3635e+04];
% K_0 = [2.3583e+04, 1.9648e+03, 6.3075e+07, 6.3075e+07];
% K_0 = [9.8243e+03, 267.5714, 7.4919e+06, 7.4919e+06];
% K_0 = [5.2144e+03, 16.1190, 1.0169e+07, 1.0169e+07];
% K_0 = [1.8984e+03, 197.0597, 4.9667e+05, 1.7008e+07];
% K_0 = [1.0031e+04, 418.4884, 2.2550e+07, 2.6274e+07];
% K_0 = [5.2144e+03, 16.1190, 1.0169e+07, 1.0169e+07];
% K_0 = [9.3680e+03, 49.7520, 1.5821e+07, 1.5821e+07];
...
T_g = [speye(length(mdofs_g)); -Kss\Ksm]; %Guyan Reduction
T_gt = transpose(T_g);
T_rg = T_g*T_r(newdofs_r,1:end);  %Guyan Reduction*RBE2 Reduction
T_rgt = transpose(T_rg); 
K_rg = T_rgt*K_(alldofs_g,alldofs_g)*T_rg; %Reduced Interface Stiffness Matrix
...
% PLOT DENSITIES  
colormap(gray); imagesc(-x,[-1,1e-3]); axis equal; axis tight; axis off;pause(1e-6);
