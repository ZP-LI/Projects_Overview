...
class DataLoader:
    ...
    def __iter__(self):
        ...
        batch = []
        iternotEmpty_flag = True
        while iternotEmpty_flag == True:
            try:
    ...
    def __len__(self):
        ...
        len_remainder = dataset_len % self.batch_size
        len_quotient = int((dataset_len - len_remainder) / self.batch_size)
        if self.drop_last:
            length = len_quotient
        else:
            if len_remainder == 0:
