...
class KeypointModel_test(nn.Module):
# class KeypointModel(pl.LightningModule):
    ...
    def __init__(self):
        ...
        self.id2l_cnn = nn.Sequential(
            nn.Conv2d(1, 1*2, (4, 4), padding=(1, 1)),
            nn.ReLU(),
            nn.Conv2d(1*2, 1*4, (4, 4), padding=(1, 1)),
            nn.ReLU(),
            nn.MaxPool2d((2, 2), stride=(2, 2)),
            # nn.Conv2d(1*4, 1*8, (4, 4), padding=(1, 1)),
            # nn.ReLU(),
            # nn.Conv2d(1*8, 1*16, (4, 4), padding=(1, 1)),
            # nn.ReLU(),
            # nn.MaxPool2d((2, 2), stride=(2, 2)),
            nn.Flatten(),
...
class DummyKeypointModel_test(pl.LightningModule):
