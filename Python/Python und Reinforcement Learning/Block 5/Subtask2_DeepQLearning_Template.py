...
class TrainSolver:
    ...
    def train(self):
        ...
        #       - Remember that Subtask1 should be executed by the algorithm of Subtask2 in order to complete the whole task.
        #       - You may use a hardcoded solution for Subtask1, but it has to be executed by the RL-algorithm
        #       - Check whether chosen action is suitable for current workpiece position and only execute action if it's suitable
